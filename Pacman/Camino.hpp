...
*/
void EncontrarCamino ( int mat[ALTO][ANCHO], tPunto , tPunto , tCamino *, int );
...
/*
  Funcion VoltearCamino
  Da vuelta la estructura dinamica Camino
*/
void VoltearCamino ( tCamino *Camino );

/*
  Funciones de manejo de la estructura dinamica Camino ( tipo pila )
*/
...
/*
  Funciones de manejo de puntos para movimiento
*/
...
void EncontrarCamino ( int aux[ALTO][ANCHO], tPunto A , tPunto B , tCamino *camino, int cantmax ) {
  /* Variables */
  int mat[ALTO][ANCHO];
