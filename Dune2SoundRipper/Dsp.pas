...
Procedure LoadVOC (Archivo : String; Inicio,Tamano:Longint; VAR Sound : VOCSound);
Procedure UnLoadVOC (VAR Sound : VOCSound);
procedure WriteDAC(level : byte);
procedure DMAStop;
procedure DMAContinue;
Procedure Playback (Tipo : VocSound);
Procedure Play_and_UnloadVOC (Archivo:String; Inicio,Tamano,Frecuencia:Longint);
