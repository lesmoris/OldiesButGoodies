...
#define INIC_FIN  3         // Estado Inicial/Final
...
#define ERR_FUNC_NODO -2    // Error en la funcion OperarNodo
...
struct _TipoAFD {
  ...
  char NomArch[20];              // Guarda el nombre del archivo .AFD
} TipoAFD;
...
//               de error definidas en la cabecera de este archivo.
int ConstruirAFD ( tAFD *AFD )
{
  // Archivos
